...
const Sidebar = () => {
  ...
  const active = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 mr-1 rounded-lg text-white text-md m-2'
  const notActive = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 mr-1 rounded-lg text-black text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-gray-500 hover:text-white'
