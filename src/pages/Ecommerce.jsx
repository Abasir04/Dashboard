...
import { earningData, SparklineAreaData, econPieChartData } from '../data/dummy'
  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        <div className="bg-white dark:bg-text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
